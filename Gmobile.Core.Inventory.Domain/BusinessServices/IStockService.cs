...
namespace Gmobile.Core.Inventory.Domain.BusinessServices
{
    public interface IStockService
    {
        ...
        Task<ResponseMessageBase<PagedResultDto<InventorySuggestDto>>> GetSuggestsInventory(StockSuggestsRequest request);
        ...
        Task<ResponseMessageBase<string>> KitingInventory(KitingDto dto);
    }
}
